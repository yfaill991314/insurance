...
<head>
    <meta charset="UTF-8">
    <title>重庆三峡学院实验教学管理系统</title>


    <!--<script type="text/javascript" src="ExtJS/bootstrap.js"></script>-->
    <!--自定义样式-->
    <link href="css/ccsBlue.css" rel="stylesheet" type="text/css"/>
    <!--字体样式-->
    ...
    <%--<script type="text/javascript" src="ExtJS/classic/build/ext-all-debug.js"></script>--%>
    <!--bootstrap-->
    ...
    <!--页面私有js-->
    <script type="text/javascript" charset="UTF-8" src="app/view/index.js"></script>
